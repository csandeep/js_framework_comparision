...
var _FabienHenon$elm_infinite_scroll$InfiniteScroll$loadMoreCmd = F2(
	function (loadMoreFunc, _p15) {
		var _p16 = _p15;
		return _FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(
			_elm_lang$core$Native_Utils.update(
				_p16._0,
...
var _FabienHenon$elm_infinite_scroll$InfiniteScroll$startLoading = function (_p17) {
	var _p18 = _p17;
	return _FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(
		_elm_lang$core$Native_Utils.update(
			_p18._0,
...
var _FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading = function (_p19) {
	var _p20 = _p19;
	return _FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(
		_elm_lang$core$Native_Utils.update(
			_p20._0,
...
var _FabienHenon$elm_infinite_scroll$InfiniteScroll$update = F3(
	function (mapper, msg, _p21) {
		var _p22 = _p21;
		var _p25 = _p22._0;
		var _p23 = msg;
		switch (_p23.ctor) {
			case 'Scroll':
				return A2(_FabienHenon$elm_infinite_scroll$InfiniteScroll$shouldLoadMore, _p25, _p23._0) ? {
					ctor: '_Tuple2',
					_0: _FabienHenon$elm_infinite_scroll$InfiniteScroll$startLoading(
						_FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(_p25)),
					_1: A2(
					...
					ctor: '_Tuple2',
					_0: _FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(_p25),
			...
			case 'CurrTime':
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _p25.loadMoreFunc(_p25.direction),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$core$Platform_Cmd$map,
									...
									A2(
										_elm_lang$core$Task$perform,
										_FabienHenon$elm_infinite_scroll$InfiniteScroll$Timeout(_p24),
										_elm_lang$core$Process$sleep(_p25.timeout))),
								_1: {ctor: '[]'}
							}
						})
				};
			default:
				return _elm_lang$core$Native_Utils.eq(_p23._0, _p25.lastRequest) ? {
					ctor: '_Tuple2',
	...
	function (mapper, value) {
		...
		if (_p26.ctor === 'Ok') {
			return A2(
				_elm_lang$core$Task$perform,
				mapper,
				_elm_lang$core$Task$succeed(_p26._0));
		} else {
...
var _user$project$Cards$loader = function (model) {
	return _FabienHenon$elm_infinite_scroll$InfiniteScroll$isLoading(model.infiniteScroll) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Cards$infoFooter = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Elm App!'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Cards$postsUrl = 'http://localhost:3000/posts/?_limit=8';
...
var _user$project$Cards$Category = F2(
	function (a, b) {
		return {name: a, slug: b};
	});
var _user$project$Cards$categoryDecoder = A3(
	...
	A3(
		...
		'name',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Cards$Category)));
var _user$project$Cards$Author = F3(
	function (a, b, c) {
		return {name: a, url: b, avatar: c};
	});
var _user$project$Cards$authorDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'author_avatar',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Cards$Author))));
var _user$project$Cards$Post = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, title: b, link: c, published: d, image: e, category: f, author: g};
	});
var _user$project$Cards$postDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'author',
	_user$project$Cards$authorDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'category',
		_user$project$Cards$categoryDecoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'thumbnail',
			_elm_lang$core$Json_Decode$string,
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'id',
							_elm_lang$core$Json_Decode$int,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Cards$Post))))))));
var _user$project$Cards$AppModel = F6(
	function (a, b, c, d, e, f) {
		return {posts: a, error: b, infiniteScroll: c, page: d, mdl: e, raised: f};
	});
var _user$project$Cards$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Cards$ClickPost = function (a) {
	return {ctor: 'ClickPost', _0: a};
};
var _user$project$Cards$Raise = F2(
	function (a, b) {
...
var _user$project$Cards$viewEntry = F2(
	function (model, post) {
		var imageUrl = A2(
			_elm_lang$core$Basics_ops['++'],
			'url(\'',
			A2(_elm_lang$core$Basics_ops['++'], post.image, '\') repeat scroll center center / cover'));
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_user$project$Cards$wide),
						'px')),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A3(_user$project$Cards$dynamic, 5, model, post),
								_1: {
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '20px auto 10px auto'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onClick(
											_user$project$Cards$ClickPost(post)),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'background', imageUrl),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'min-height', '130px'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'min-width', '400px'),
								_1: {ctor: '[]'}
							}
						}
					},
						...
						},
						{
							...
							_0: A2(
								_debois$elm_mdl$Material_Card$head,
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-bottom', '2px'),
										_1: {ctor: '[]'}
									}
								},
								{
...
var _user$project$Cards$InfiniteScrollMsg = function (a) {
	return {ctor: 'InfiniteScrollMsg', _0: a};
};
var _user$project$Cards$viewEntries = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _FabienHenon$elm_infinite_scroll$InfiniteScroll$infiniteScroll(_user$project$Cards$InfiniteScrollMsg),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Cards$viewEntry(model),
					model.posts)),
			_1: {
				ctor: '::',
				_0: _user$project$Cards$loader(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Cards$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('cardmvcwrapper'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('cardsapp'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Cards$viewEntries(model),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Cards$infoFooter(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Cards$NewPosts = function (a) {
	return {ctor: 'NewPosts', _0: a};
};
var _user$project$Cards$load = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Cards$NewPosts,
		A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(_user$project$Cards$postDecoder)));
};
var _user$project$Cards$loadMore = function (dir) {
	return _user$project$Cards$load(_user$project$Cards$postsUrl);
};
var _user$project$Cards$initialModel = A6(
	_user$project$Cards$AppModel,
	{ctor: '[]'},
	'',
	A2(
		_FabienHenon$elm_infinite_scroll$InfiniteScroll$direction,
		_FabienHenon$elm_infinite_scroll$InfiniteScroll$Bottom,
		A2(
			_FabienHenon$elm_infinite_scroll$InfiniteScroll$offset,
			5,
			_FabienHenon$elm_infinite_scroll$InfiniteScroll$init(_user$project$Cards$loadMore))),
	1,
	_debois$elm_mdl$Material$model,
	_elm_lang$core$Dict$fromList(
		{ctor: '[]'}));
var _user$project$Cards$loadMorePage = function (page) {
	return _user$project$Cards$load(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Cards$postsUrl,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'&_page=',
				_elm_lang$core$Basics$toString(page))));
};
var _user$project$Cards$init = function () {
	var model = _user$project$Cards$initialModel;
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{
				infiniteScroll: _FabienHenon$elm_infinite_scroll$InfiniteScroll$startLoading(model.infiniteScroll)
			}),
		_1: _user$project$Cards$loadMorePage(1)
	};
}();
var _user$project$Cards$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Cards$Mdl, _p1._0, model);
			case 'InfiniteScrollMsg':
				var _p2 = _elm_lang$core$Debug$log('invoked infinitescroll!');
				var _p3 = A3(_FabienHenon$elm_infinite_scroll$InfiniteScroll$update, _user$project$Cards$InfiniteScrollMsg, _p1._0, model.infiniteScroll);
				var infiniteScroll = _p3._0;
				var cmd = _p3._1;
				var newInfiniteScroll = A2(
					_FabienHenon$elm_infinite_scroll$InfiniteScroll$loadMoreCmd,
					function (_p4) {
						return _user$project$Cards$loadMorePage(model.page);
					},
					infiniteScroll);
				return {
					ctor: '_Tuple2',
			...
			case 'NewPosts':
				if (_p1._0.ctor === 'Ok') {
					var _p6 = _p1._0._0;
					var infiniteScroll = _FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading(model.infiniteScroll);
					var newRaisedList = A2(
						_elm_lang$core$List$map,
						function (p) {
							return {ctor: '_Tuple2', _0: p.id, _1: -1};
						},
						_p6);
					var newRaisedDict = _elm_lang$core$Dict$fromList(newRaisedList);
					var _p5 = _elm_lang$core$Debug$log(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Posts: ',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								posts: A2(_elm_lang$core$Basics_ops['++'], model.posts, _p6),
								infiniteScroll: infiniteScroll,
								page: model.page + 1,
								raised: A2(_elm_lang$core$Dict$union, model.raised, newRaisedDict)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p7 = _p1._0._0;
					var infiniteScroll = _FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading(model.infiniteScroll);
					var message = _elm_lang$core$Debug$log(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Error: ',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								error: _elm_lang$core$Basics$toString(_p7),
								infiniteScroll: infiniteScroll
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'Raise':
				var newRaised = A3(_elm_lang$core$Dict$insert, _p1._0.id, _p1._1, model.raised);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$load(_p1._0.link)
				};
		}
	});
var _user$project$Cards$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Cards$init,
		view: _user$project$Cards$view,
		update: _user$project$Cards$update,
...
var Elm = {};
Elm['Cards'] = Elm['Cards'] || {};
if (typeof _user$project$Cards$main !== 'undefined') {
    _user$project$Cards$main(Elm['Cards'], 'Cards', undefined);
}
